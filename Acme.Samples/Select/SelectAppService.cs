...
{
    [DisableAuditing]
    public class CustomSelectEntityChange : CustomSelectAppService<AuditLog, Guid>
        //, ICustomSelectEntityChange
    {
        public CustomSelectEntityChange(IReadOnlyRepository<AuditLog, Guid> repository) : base(repository)
        {
        }
