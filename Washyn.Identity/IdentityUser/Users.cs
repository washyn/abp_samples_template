...
namespace Acme.Identity.IdentityUser
{
        ...
        public void SetRole(string rolName)
        {
            ...
            if (rolName != Consts.RolConsts.Administrador && rolName != Consts.RolConsts.Usuario)
            {
                throw new ArgumentException(
                    $"Rol value only be set as {Consts.RolConsts.Administrador} or {Consts.RolConsts.Usuario}");
            }
        ...
        UpdateUserDto>
    {
        ...
        public UserAppService(IRepository<User, int> repository, UserManager userManager,
    ...
    public class UserManager : DomainService
    {
        ...
        public async Task<User> CreateUser(CreateUserDto userDto)
        {
            ...
            {
                Name = userDto.Name, Surname = userDto.Surname, PhoneNumber = userDto.PhoneNumber,
            };
            return newUser;
        }
    }
